...
class Login extends Component {
    ...
    render() {
        return (
            <div className="flows">
                <div className="flow">
                    <button id="signin" onClick={this.signIn} disabled={!this.state.signin_button}>Sign in</button>
                    <button id="signout" onClick={this.signOut} disabled={!this.state.revoke_button}>Sign Out</button>
                    {
